...
def stitch_images(png_structures: list[str], png_energies: list[str], png_top_views: list[str]):
    ...
    for i in range(len(structures)):
        stitched.append(Image.new('RGB', (structures[i].width + energies[i].width, structures[i].height)))
        ...
        stitched[i].paste(top_views[i], (structures[i].width + 1, structures[i].height - top_views[i].height))
