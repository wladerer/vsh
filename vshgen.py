...
def parse_args():
    ...
    parser.add_argument('--ediff', type=float,
                        help='Energy convergence criterion')
    parser.add_argument('--ediffg', type=float,
                        help='Force convergence criterion')
    parser.add_argument('--algo', type=str, choices=['Normal', 'Fast', 'VeryFast'],
    ...
    parser.add_argument('--kgamma', action='store_true',
                        help='Use Gamma-centered kpoint grid')
    parser.add_argument('--linemode', action='store_true', help='Use line mode for band structure')
    ...
    parser.add_argument('--lreal', type=str, choices=['Auto', 'None', 'A', 'B', 'C'],
                        help='Type of real-space projection')
    parser.add_argument('--laechg', action='store_true', help='Write AECCAR0 and AECCAR2')    
    # 

    # Precison parameters
    parser.add_argument('--prec', type=str, choices=['N', 'L', 'M', 'H', 'A'], help='Precision')
    ...
    parser.add_argument('--icharg', type=int, choices=[0, 1, 2, 4, 10, 11, 12],
