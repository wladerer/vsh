...
def unpack_indices(indices: tuple[np.ndarray], element_list: list[str], bond_lengths: np.ndarray):
    ...
    for length, pair in enumerate(indices):
        ...
        entry = {f"{first_element}{first_element_index}-{second_element}{second_element_index}": bond_length}
...
def read_vasp_output():
    ...
    parser.add_argument('--volume', help='Prints the volume of the structure', action='store_true')
    parser.add_argument('--conflicts',type=float, help='Prints the conflicting atoms')
    parser.add_argument('--cell', help='Prints the unit cell dimensions', action='store_true')
    parser.add_argument('--params', help='Prints the unit cell parameters (a,b,c) of the structure', action='store_true')
    parser.add_argument('--symmetry', help='Prints the space group number and symbol', action='store_true')
    parser.add_argument('--forces', help='Prints the forces on the atoms', action='store_true')
    parser.add_argument('--order', help='Prints the order of the atoms', action='store_true')
    parser.add_argument('--energy', help='Prints the energy of the structure', action='store_true')
    parser.add_argument('--pullay', help='Prints the pullay stress tensor', action='store_true')
    parser.add_argument('--vacuum', help='Prints the vacuum of the structure', action='store_true')
