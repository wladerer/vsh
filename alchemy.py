...
def convert_atoms():
    ...
    parser.add_argument('-i', '--indices', type=int, nargs='+', help='Atom indices to convert')
    parser.add_argument('-t', '--type', type=str, help='Atom type to convert')
    parser.add_argument('-o', '--output', type=str, default='converted.vasp' , help='Output file name')
