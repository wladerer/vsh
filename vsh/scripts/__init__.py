...
def incar(subparsers):
    ...
    subp_incar.add_argument("--write", choices=['bulk', 'slab', 'band-slab', 'band', 'single-point', 'single-point-slab', 'single-point-slab-soc'], help="Write an INCAR file from the defaults in incar.json")
