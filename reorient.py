...
def parse_args():
    ...
    parser.add_argument(
        "-f",
        "--filename",
        help="The filename of the molecule to be reoriented.",
        required=True,
    )
    parser.add_argument(
        "-o",
        "--output",
        help="The filename of the reoriented molecule.",
        required=False,
    )
    parser.add_argument(
        "-m",
        "--matrix",
        help="The transformation matrix to be used for reorienting the molecule.",
        required=False,
    )
