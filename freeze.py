...
def freeze_atoms():
    ...
    parser.add_argument('-i', '--indices', type=int, nargs='+', help='Atom indices to freeze')
    ...
    parser.add_argument('-o', '--output', type=str, default='frozen.vasp' , help='Output file name')
    #sort atoms
    parser.add_argument('--sort', action='store_true', help='Sort atoms')
    parser.add_argument('--intersection', action='store_true', help='Freeze atoms that satisfy all conditions')
